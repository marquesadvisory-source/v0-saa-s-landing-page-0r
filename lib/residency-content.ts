// Approved English source for /residency. Other languages require separately approved translations.
export const residencyContent = {
  "hero": [
    "Establish a long-term presence in Costa Rica through a residence strategy coordinated around your personal, family and investment objectives.",
    "Marqués Advisory & Investments provides private client coordination for international individuals and families considering residence, real estate and qualifying investment opportunities in Costa Rica."
  ],
  "facts": [
    [
      "Investor",
  ...
  "overview": [
    "Costa Rica offers residence pathways for investors, individuals with qualifying independent income and retirees.",
    "For international clients considering Costa Rica as part of their long-term residence, investment or mobility planning, Marqués coordinates the applicable residence pathway, investment considerations, documentation and local execution.",
    "Residence and tax residence are separate matters, and each client’s circumstances should be evaluated individually."
  ],
  "program": [
    "Costa Rica provides several temporary residence pathways for foreign nationals who wish to establish a more permanent legal presence in the country.",
    "For qualifying investors, the Investor Residency pathway begins with an investment of USD 150,000, subject to the applicable legal requirements and verification of the investment.",
    "Alternative pathways are available for applicants who receive qualifying independent income or a lifetime pension.",
    "Marqués assists private clients in evaluating the appropriate pathway and coordinates the residence process alongside the relevant legal, tax and immigration professionals where required."
  ],
  "benefits": [
    [
  ...
  "benefitNote": "Residence status does not automatically confer Costa Rican citizenship, tax residence or passport rights.",
  ...
  "journeyStatement": "You do not need to relocate to Costa Rica simply to begin your residence process.",
  "journeyNote": "Much of the preparation may begin remotely. Certain immigration formalities require physical presence in Costa Rica and are coordinated at the appropriate stage of the process.",
  "procedure": [
  ...
  "procedureNote": "Marqués coordinates the process and the relevant professional relationships but does not act as the Costa Rican immigration authority.",
  "citizenship": [
    "Costa Rican residence and Costa Rican citizenship are separate legal statuses.",
    "Residence may form part of a client’s longer-term planning, but eligibility for naturalization depends on the applicable constitutional and legal requirements, including the applicant’s individual circumstances and qualifying period of residence.",
    "Marqués does not represent residence as an automatic route to citizenship and coordinates specialized legal advice where citizenship planning becomes relevant."
  ],
  "faqs": [
    [
    ...
    [
      "Can I start my Costa Rica residency process while I am still abroad?",
      [
        "Yes. Much of the preparation can begin before the client travels to Costa Rica.",
        "Marqués can coordinate the initial evaluation, identify the appropriate residence pathway, review investment considerations, prepare a personalized document checklist and pre-review foreign documentation remotely.",
        "Certain immigration formalities still require physical presence in Costa Rica."
      ]
    ],
    [
      "When do I actually need to travel to Costa Rica?",
      [
        "You do not necessarily need to travel to Costa Rica simply to begin preparing your residence process.",
        "Physical presence is coordinated when required for in-country formalities, which may include fingerprint registration, immigration documentation and other procedures applicable to the individual case.",
        "The timing and number of visits depend on the applicant’s circumstances and the requirements applicable to the case."
      ]
    ],
    [
      "Which documents do I need to obtain in my home country?",
      [
        "Common foreign documents may include a birth certificate, criminal-record certificate, marriage certificate where applicable and civil documents relating to dependent family members.",
        "The exact requirements depend on nationality, residence category and family composition.",
        "Marqués provides a personalized checklist before documents are obtained so that clients can prepare the correct documentation from their country of origin or residence."
      ]
    ],
    [
      "Do my foreign documents need to be apostilled or legalized?",
      [
    ...
    [
      ...
      [
        "Fingerprint registration forms part of the Costa Rican immigration process.",
        "Marqués coordinates the appropriate stage for completing this requirement in Costa Rica as part of the overall residence process."
      ]
    ],
    [
