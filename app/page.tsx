      ...
      <section className="border-b border-border">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 md:grid-cols-[1.05fr_0.95fr] md:px-8 md:py-28">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-3xl font-serif text-5xl leading-[1.03] text-primary md:text-7xl">Establish Your Presence in Costa Rica.</h1>
            <p className="mt-7 max-w-xl text-base leading-7 text-muted-foreground md:text-lg">Private advisory for residency, real assets and investment opportunities in Costa Rica.</p>
          ...
          <div className="relative min-h-[360px] overflow-hidden bg-primary md:min-h-[500px]"><Image src="/projects/plaza-los-mangos.png" alt="Costa Rican real estate opportunity" fill className="object-cover opacity-80" priority sizes="(max-width: 768px) 100vw, 45vw" /><div className="absolute inset-0 bg-primary/20" /><div className="absolute bottom-0 left-0 right-0 bg-primary/90 p-6 text-primary-foreground"><p className="mb-2 text-[10px] uppercase tracking-[0.18em] text-accent">The Marqués approach</p><p className="max-w-sm text-sm leading-6 text-primary-foreground/75">Personal context, disciplined diligence and a long view of what comes next.</p></div></div>
        </div>
      </section>
