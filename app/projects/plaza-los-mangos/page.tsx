    ...
    <main className="min-h-screen bg-[#0D1B2A] text-white">
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="mb-5 text-xs uppercase tracking-[0.18em] text-[#C9A96E]">
              <T>Institutional Showcase
            </T></p>
            <h1 className="font-serif text-4xl leading-tight md:text-6xl"><T>Plaza Los Mangos</T></h1>
            <p className="mt-6 text-sm uppercase tracking-[0.14em] text-white/50">
              <T>Santa Cruz, Guanacaste, Costa Rica
            </T></p>
          </div>
          <div className="space-y-6 text-base leading-8 text-white/70">
            <p>
              <T>Plaza Los Mangos is being structured as a mixed-use real asset opportunity in Santa Cruz, Guanacaste, designed to integrate commercial, hospitality, residential and service-oriented uses within a single institutional development framework.
            </T></p>
            <p>
              <T>The project is currently under structuring and remains subject to diligence, documentation, regulatory review and appropriate professional coordination.
            </T></p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl space-y-16">
          <section className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="font-serif text-3xl leading-tight md:text-4xl">
                <T>A mixed-use real asset framework for a growing Guanacaste market.
              </T></h2>
            </div>
            <p className="text-sm leading-7 text-slate-700">
              <T>Plaza Los Mangos is positioned as a predevelopment project where land-use strategy, component integration, documentation and institutional preparation are being evaluated before any private capital-facing process.
            </T></p>
          </section>
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <article className="border border-[#E5DDD0] bg-white p-8">
              ...
              <h2 className="mb-5 text-xl font-semibold"><T>Asset Profile</T></h2>
              <div className="grid gap-5">
                {assetProfile.map((item) => (
                  <div key={item.label} className="border-b border-[#E5DDD0] pb-4">
                    <p className="mb-1 text-xs uppercase tracking-[0.14em] text-[#C9A96E]"><T>{item.label}</T></p>
                    <p className="text-sm text-slate-700"><T>{item.value}</T></p>
                  </div>
                ))}
              </div>
            </article>
            ...
            <article className="border border-[#E5DDD0] bg-white p-8">
              ...
              <h2 className="mb-5 text-xl font-semibold"><T>Development Components</T></h2>
          ...
          <section className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="font-serif text-3xl leading-tight md:text-4xl">
                <T>Santa Cruz, Guanacaste.
              </T></h2>
            </div>
            <p className="text-sm leading-7 text-slate-700">
              <T>The location thesis is centered on Santa Cruz as a Guanacaste market with commercial, residential, hospitality and service-oriented demand drivers. Additional location materials may be available upon appropriate review with qualified institutional counterparties.
            </T></p>
          </section>
          ...
          <section>
            <div className="mb-8">
              <p className="mb-4 text-xs uppercase tracking-[0.18em] text-[#C9A96E]">
                <T>Institutional Structuring Approach
              </T></p>
              <h2 className="max-w-3xl font-serif text-3xl leading-tight md:text-4xl">
                <T>From origination to monetization, subject to diligence and professional review.
              </T></h2>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              {approach.map((item, index) => (
                <article key={item.title} className="border border-[#E5DDD0] bg-white p-6">
                  ...
                  <h3 className="mb-3 text-base font-semibold"><T>{item.title}</T></h3>
          ...
          <section className="grid gap-6 md:grid-cols-3">
            <article className="border border-[#E5DDD0] bg-white p-8 md:col-span-2">
              ...
              <h2 className="mb-4 text-xl font-semibold"><T>MA&I Role</T></h2>
              <p className="text-sm leading-7 text-slate-700">
                <T>Marqués Advisory & Investments supports origination, investment structuring, capital readiness, professional coordination and monetization strategy for Plaza Los Mangos.
              </T></p>
            </article>
            <article className="border border-[#E5DDD0] bg-white p-8">
              <ShieldCheck className="mb-5 text-[#C9A96E]" size={24} />
              <h2 className="mb-4 text-xl font-semibold"><T>Current Status</T></h2>
              <p className="text-sm leading-7 text-slate-700">
                <T>Predevelopment & institutional structuring. Materials remain subject to diligence and appropriate review.
              </T></p>
            </article>
          </section>
          ...
          <section className="bg-[#112032] p-8 text-white md:p-12">
            ...
            <h2 className="max-w-3xl font-serif text-3xl leading-tight md:text-4xl">
              <T>Additional materials may be shared only with qualified parties following appropriate review.
            </T></h2>
            <p className="mt-6 max-w-3xl text-sm leading-7 text-white/70">
              <T>This page provides institutional context only. Any further project information remains subject to confidentiality procedures, legal documentation and professional review.
            </T></p>
            <Link
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-5xl">
          <p className="mb-3 text-xs uppercase tracking-[0.18em] text-[#C9A96E]"><T>Disclaimer</T></p>
